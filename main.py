...
async def on_guild_join(guild):
	...
	if general and general.permissions_for(guild.me).send_messages:
		desc = "Hello !\n\nI am [Kamil Debowski](https://codeforces.com/profile/Errichto), or better known as Errichto. I have been to ICPC World Finals 2015, as a part of team from University of Warsaw and won a bronze medal"
		...
		desc += "\n\nCheck Siddharth's [Github](https://github.com/s-i-d-d-i-s) to get updates on this Project"
